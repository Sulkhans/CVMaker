          ...
          <div className="text-lg flex flex-col items-start gap-4 lg:text-lg xl:gap-8">
            ...
            <div>
              ...
              <p className="max-w-[600px]">
                Our CV-making service is dedicated to creating well-crafted CVs,
                providing{" "}
          ...
          <ol className="flex flex-col gap-6">
            <li className="flex items-center gap-4">
              ...
              <p>
                ...
                our CV maker. No more struggling with formatting or layout - our
                platform automates these tasks so you can focus on what really
            ...
            <li className="flex items-center gap-4">
              ...
              <p>
                ...
                <span className="text-custom-orange">intuitive</span> interface
                for easy navigation. Just input your information, and our
            ...
            <li className="flex items-center gap-4">
              ...
              <p>
                ...
                process of creating a resume, saving you valuable time. Instead
                of spending hours formatting and editing, our platform allows
                you to create your resume quickly and{" "}
